...
class ConfigurationPanel:
    ...
    Additionally, this panel updates the preferences that back the UI elements
    """
    ...
    def _layoutAlgorithmParameters(self, parentPanel: SizedPanel):
        ...
        attractionForce: SpinCtrlDouble = SpinCtrlDouble(attractionPanel, min=0.1, max=1.0, inc=0.1, pos=Point(-1, -1), size=Size(50, 35))
    ...
    def _attractionForceChanged(self, event: SpinDoubleEvent):
        ...
        floatSpin: SpinCtrlDouble = cast(SpinCtrlDouble, event.GetEventObject())
